...
--graph=c:/tmp/my_frozen_graph.pb --labels=c:/tmp/catdog_commands_train/conv_labels.txt --wav=c:/users/richa/Audio/dataset-bird/down/0ab3b47d_nohash_0.wav
...
if __name__ == '__main__':
  ...
  if FLAGS.wav == '':
    ...
    while True:
      FLAGS.wav = filedialog.askopenfilename()
      #FLAGS.wav = 'c:/users/richa/Audio/dataset-bird/down/0ab3b47d_nohash_0.wav'
