...
bird_kaggle_dest_folder = dataset_folder + 'bird_kaggle/'
...
for f in glob.glob(bird_kaggle_source_folder + '/*.{}'.format('wav')):
  # sh.copy(f, cat_dest_folder)
  split_bird_audio(f, dest_folder=bird_kaggle_dest_folder, plot_folder='C:/Users/richa/Audio/dataset_v0_source/plots/')

# Birds: Warblr
bird_warblr_source_folder = dataset_source_folder + 'bird_warblr/'
bird_warblr_dest_folder = dataset_folder + 'bird_warblr/'
...
for f in glob.glob(bird_warblr_source_folder + '/*.{}'.format('wav')):
  # sh.copy(f, cat_dest_folder)
  split_bird_audio(f, dest_folder=bird_warblr_dest_folder,
