...
import hot_keyword_recognition_code.models
from hot_keyword_recognition_code.audio import AudioProcessor
...
def main():
    ...
    logits, dropout_prob = hot_keyword_recognition_code.models.create_model(
        fingerprint_input,
    ...
    if FLAGS.start_checkpoint:
        hot_keyword_recognition_code.models.load_variables_from_checkpoint(sess, FLAGS.start_checkpoint)
